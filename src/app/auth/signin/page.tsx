    ...
    <div className="min-h-screen bg-background flex flex-col p-8">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="w-full max-w-sm">
          ...
          {/* Auth Options - Hide when email form is shown */}
          {!showEmailForm && (
          ...
          {/* Divider - Hide when email form is shown */}
          {!showEmailForm && (
          ...
          {/* Show "Continue with email" button when OAuth options are visible */}
          {!showEmailForm && (
            <Button
          ...
          {/* Email/Password Form - Show when user clicks "Continue with email" */}
          {showEmailForm && (
            <>
              {/* Back button */}
              <button
                ...
                className="flex items-center gap-2 text-sm text-neutral-600 dark:text-neutral-400 hover:text-neutral-900 dark:hover:text-neutral-50 transition-colors mb-4"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
              ...
              <form onSubmit={handleEmailSignIn} className="space-y-3">
                {error && (
                  <div className="p-4 bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/50 rounded-xl text-red-700 dark:text-red-400 text-sm flex items-start gap-3">
                    <svg
