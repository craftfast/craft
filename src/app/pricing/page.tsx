          ...
          <div className="mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="relative bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-2xl p-6">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400">
                  Use any AI model, run code in sandboxes, store your projects.
              ...
              <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-2xl p-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-foreground">$0.003</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-neutral-600 dark:text-neutral-400">
                      Claude Sonnet
                    </span>
                    <span className="font-medium text-foreground">$0.030</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-2xl p-6">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-foreground">$0.033</span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-neutral-600 dark:text-neutral-400">
                      Claude Sonnet
                    </span>
                    <span className="font-medium text-foreground">$0.375</span>
                  </div>
                </div>
              </div>
