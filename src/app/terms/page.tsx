            ...
            <section className="mb-8">
              ...
              <ul className="space-y-2">
                <li>
                  ...
                  processed securely through Razorpay in USD
                </li>
                <li>
                ...
                <li>
                  ...
                  debit cards, UPI, net banking, and other methods supported by
                  Razorpay
                </li>
                <li>
                  <strong>Taxes:</strong> GST (18%) applies to platform fees for
                  Indian customers. International customers are exempt
