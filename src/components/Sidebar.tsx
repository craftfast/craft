    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          ...
          {/* Main Navigation */}
          <div className="flex-1 overflow-y-auto py-4 px-2 space-y-6 [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-muted-foreground/20 [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-muted-foreground/30">
            {/* Primary Nav */}
            <Section>
            ...
            {/* Copyright - inside scrollable area */}
            <div className="pt-4">
